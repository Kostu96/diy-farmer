...
const _Graph2DAxis = preload("res://plugins/graph_2d/custom_nodes/axis.gd")
const _Graph2DCoord = preload("res://plugins/graph_2d/custom_nodes/coordinate.gd")
const _Graph2DGrid = preload("res://plugins/graph_2d/custom_nodes/grid.gd")
const _Graph2DLegend = preload("res://plugins/graph_2d/custom_nodes/legend.gd")
